...
public class GenericUpdatePatchByIdProviderSql extends GenericUpdatePatchByCriteriaProviderSql {
	...
	public String provideSql(GenericProviderContext context, Object params) {
		...
		Object id = paramMap.remove(Constants.ID);
		Assert.notNull(id, "主键值不能为空");
		Predicate predicate = Predicates.predicate();
		predicate.eq(idAttr.getName(), id);
