...
public class Conditions {
	 ...
	 * @return 条件
	 */
	public static Condition like(String attrName, Object value, boolean ignoreTypeHandler) {
		return new ConditionImpl(Type.LIKE, attrName, ignoreTypeHandler, new Object[] { value });
	}
	/**
	 ...
	 * @return 条件
	 */
	public static Condition notContaining(String attrName, Object value, boolean ignoreTypeHandler) {
		return new ConditionImpl(Type.NOT_CONTAINING, attrName, ignoreTypeHandler, new Object[] { value });
	}
	/**
	 * 不包含：NOT LIKE %{value}%
	 * @param attrGetter 属性Getter
	 ...
	 * @return 条件
	 */
	public static <T> Condition notContaining(SerializableFunction<T, ?> attrGetter, Object value, boolean ignoreTypeHandler) {
		return notContaining(LambdaReflections.fnToFieldName(attrGetter), value, ignoreTypeHandler);
	}
	/**
	 * 包含：LIKE %{value}%
	 * @param attrName 属性名
	 ...
	 * @return 条件
	 */
	public static Condition containing(String attrName, Object value, boolean ignoreTypeHandler) {
		return new ConditionImpl(Type.CONTAINING, attrName, ignoreTypeHandler, new Object[] { value });
	}
	/**
	 * 包含：LIKE %{value}%
	 * @param attrGetter 属性Getter
	 ...
	 * @return 条件
	 */
	public static <T> Condition containing(SerializableFunction<T, ?> attrGetter, Object value, boolean ignoreTypeHandler) {
		return containing(LambdaReflections.fnToFieldName(attrGetter), value, ignoreTypeHandler);
	}
	/**
