...
public class GenericBatchInsertProviderSql extends GenericCachingProviderSql {
	...
	private static final List<DbEnum> COMMON_BATCH_INSERT_DBS = Arrays.asList(DbEnum.MYSQL, DbEnum.MARIADB, DbEnum.POSTGRES, DbEnum.SQLITE, DbEnum.OSCAR, DbEnum.CLICKHOUSE, DbEnum.DM, DbEnum.OPENGAUSS);
