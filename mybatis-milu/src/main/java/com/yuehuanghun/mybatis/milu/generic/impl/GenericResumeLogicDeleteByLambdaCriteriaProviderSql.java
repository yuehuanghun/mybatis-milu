...
public class GenericResumeLogicDeleteByLambdaCriteriaProviderSql extends GenericResumeLogicDeleteByCriteriaProviderSql {
	...
	public String getMethodName() {
		return "resumeLogicDeletedByLambdaCriteria";
	}
}
