...
public class DeleteSqlTemplateBuilder extends SqlTemplateBuilder {
	private final Predicate predicate;

	public DeleteSqlTemplateBuilder(Entity entity, MiluConfiguration configuration, Predicate predicate) {
