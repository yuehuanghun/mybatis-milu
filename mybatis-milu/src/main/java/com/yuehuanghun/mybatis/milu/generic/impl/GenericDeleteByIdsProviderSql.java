...
public class GenericDeleteByIdsProviderSql extends GenericCachingProviderSql {

	@Override
	public String provideCachingSql(GenericProviderContext context, Object params) {
		Entity entity = context.getEntity();
		StringBuilder sqlBuilder = new StringBuilder(128).append(Segment.SCRIPT_LABEL);
